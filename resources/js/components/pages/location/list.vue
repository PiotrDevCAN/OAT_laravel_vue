            ...
            return {
                ...
                filters: [
                    ...
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'locations', dataKey: 'location', label: 'Locations' }
                        ]
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'shores', dataKey: 'shore', label: 'Shore' }
                        ]
                    }
                ],
        ...
        computed: {
            ...
            */
            ...
            ...mapGetters({
                ...
                getFilterMapDataById: 'locations/getFilterDataById',
                getFilterMapStateById: 'locations/getFilterLoadedStateById',
                getFilterMapSelectedById: 'locations/getFilterSelectedValueById',

                getColumnsMapByType: 'locations/getColumnsByType',
                getRecordsMapByType: 'locations/getRecordsByType',
                getLoadingMapByType: 'locations/getLoadingByType',
                getLoadedMapByType: 'locations/getLoadedByType',

                getRecordsCountByType: 'locations/getRecordsCountByType',
                getHoursCountByType: 'locations/getRecordsHoursCountByType'
            })
        },
        beforCreate() {
        ...
        methods: {
            ...
            */
            ...mapActions({
                ...
                getFiltersData: 'locations/fetchFiltersData',
                getTableData: 'locations/fetchTableData'
            }),
