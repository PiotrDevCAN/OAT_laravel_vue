            ...
            return {
                ...
                filters: [
                    ...
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'competencies', dataKey: 'competency', label: 'Service Lines' }
                        ]
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'approvers', dataKey: 'approver', label: 'Approvers' }
                        ]
                    }
                ],
                ...
                summary: [
                    ...
                    },
                    {
                        ...
                        type: 'amount',
                        inputs: [
                            { id: 'awaitingAmount', type: 'competency', label: 'Awaiting Approval Requests', value: '0' }
                        ]
                    },
                    {
                        lg: 6,
                        type: 'hours',
                        inputs: [
                            { id: 'awaitingHours', type: 'competency', label: 'Awaiting Approval Hours', value: '0' }
                        ]
                    }
                ],
        ...
        computed: {
            ...
            */
            ...
            ...mapGetters({
                ...
                getFilterMapDataById: 'competencies/getFilterDataById',
                getFilterMapStateById: 'competencies/getFilterLoadedStateById',
                getFilterMapSelectedById: 'competencies/getFilterSelectedValueById',

                getColumnsMapByType: 'competencies/getColumnsByType',
                getRecordsMapByType: 'competencies/getRecordsByType',
                getLoadingMapByType: 'competencies/getLoadingByType',
                getLoadedMapByType: 'competencies/getLoadedByType',

                getRecordsCountByType: 'competencies/getRecordsCountByType',
                getHoursCountByType: 'competencies/getRecordsHoursCountByType'
            })
        },
        beforCreate() {
        ...
        methods: {
            ...
            */
            ...mapActions({
                ...
                getFiltersData: 'competencies/fetchFiltersData',
                getTableData: 'competencies/fetchTableData'
            }),
