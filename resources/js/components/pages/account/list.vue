            ...
            return {
                ...
                filters: [
                    ...
                    },
                    {
                        lg: 3,
                        selects: [
                            { id: 'accounts', dataKey: 'account', label: 'Account' }
                        ]
                    },
                    {
                        lg: 3,
                        selects: [
                            { id: 'approvers', dataKey: 'approver', label: 'Approver' }
                        ]
                    },
                    {
                        lg: 3,
                        selects: [
                            { id: 'verifieds', dataKey: 'verified', label: 'Verified' }
                        ]
                    },
                    {
                        lg: 3,
                ...
                summary: [
                    ...
                    },
                    {
                        ...
                        type: 'amount',
                        inputs: [
                            { id: 'awaitingAmount', type: 'account', label: 'Awaiting Approval Requests', value: '0' }
                        ]
                    },
                    {
                        lg: 6,
                        type: 'hours',
                        inputs: [
                            { id: 'awaitingHours', type: 'account', label: 'Awaiting Approval Hours', value: '0' }
                        ]
                    }
                ],
        ...
        computed: {
            ...
            */
            ...
            ...mapGetters({
                ...
                getFilterMapDataById: 'accounts/getFilterDataById',
                getFilterMapStateById: 'accounts/getFilterLoadedStateById',
                getFilterMapSelectedById: 'accounts/getFilterSelectedValueById',

                getColumnsMapByType: 'accounts/getColumnsByType',
                getRecordsMapByType: 'accounts/getRecordsByType',
                getLoadingMapByType: 'accounts/getLoadingByType',
                getLoadedMapByType: 'accounts/getLoadedByType',

                getRecordsCountByType: 'accounts/getRecordsCountByType',
                getHoursCountByType: 'accounts/getRecordsHoursCountByType'
            })
        },
        beforCreate() {
