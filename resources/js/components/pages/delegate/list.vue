            ...
            return {
                ...
                filters: [
                    ...
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'userIntranets', dataKey: 'user_intranet', label: 'User Intranet' }
                        ]
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'delegateIntranets', dataKey: 'delegate_intranet', label: 'Delegate Intranet' }
                        ]
                    },
                    {
                        lg: 4,
                        selects: [
                            { id: 'delegateNotesIds', dataKey: 'delegate_notesid', label: 'Delegate Notes Id' }
                        ]
                    }
                ],
                ...
                summary: [
                    ...
                    },
                    {
                        ...
                        type: 'amount',
                        inputs: [
                            { id: 'awaitingAmount', type: 'delegate', label: 'Awaiting Approval Requests', value: '0' }
                        ]
                    },
                    {
                        lg: 6,
                        type: 'hours',
                        inputs: [
                            { id: 'awaitingHours', type: 'delegate', label: 'Awaiting Approval Hours', value: '0' }
                        ]
                    }
                ],
        ...
        computed: {
            ...
            */
            ...
            ...mapGetters({
                ...
                getFilterMapDataById: 'delegates/getFilterDataById',
                getFilterMapStateById: 'delegates/getFilterLoadedStateById',
                getFilterMapSelectedById: 'delegates/getFilterSelectedValueById',

                getColumnsMapByType: 'delegates/getColumnsByType',
                getRecordsMapByType: 'delegates/getRecordsByType',
                getLoadingMapByType: 'delegates/getLoadingByType',
                getLoadedMapByType: 'delegates/getLoadedByType',

                getRecordsCountByType: 'delegates/getRecordsCountByType',
                getHoursCountByType: 'delegates/getRecordsHoursCountByType'
            })
        },
        beforCreate() {
        ...
        methods: {
            ...
            */
            ...mapActions({
                ...
                getFiltersData: 'delegates/fetchFiltersData',
                getTableData: 'delegates/fetchTableData'
            }),
